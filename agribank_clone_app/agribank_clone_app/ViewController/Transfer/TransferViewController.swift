...
class TransferViewController: BaseViewController {
    ...
    let data: [TransferEntity] = [.init(title: "Chuyển khoản nội bộ qua  TK/SĐT", image: "ic48PxCKnoiboquaStk_Normal"), .init(title: "CK liên NH qua số            tài khoản", image: "ic48PxCKlienNHquaStk_Normal"), .init(title: "CK liên NH qua số thẻ", image: "ic48PxCKlienNHquasothe_Normal"), .init(title: "Chuyển khoản 24/7 mã QR", image: "ic48PxQrpay_Normal")]
